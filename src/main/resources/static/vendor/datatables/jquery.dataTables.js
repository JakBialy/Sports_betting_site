...
(function( $, window, document, undefined ) {
	...
	function _fnSort ( oSettings )
	{
		...
		{
			// Create a value - apiKey array of the current row positions such that we can use their
	...
	function _fnLoadState ( settings, oInit, callback )
	{
		...
		var loaded = function ( s ) {
			...
			// Restore apiKey features - todo - for 1.11 this needs to be done by
			// subscribed events
	...
	/**
	 * Bind an event handers to allow a click or return apiKey to activate the callback.
	...
	DataTable.defaults = {
		 ...
		 *  @param {array} data A apiKey/value pair object containing the data to send
		 *    to the server
		 ...
		 * allows you to tab through the controls and press the enter apiKey to activate them.
